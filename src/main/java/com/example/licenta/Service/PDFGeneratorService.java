...
public class PDFGeneratorService {
    ...
    public void crearePDF(HttpServletResponse response) throws IOException {
        ...
        String writingExerciseImagePath = "static/ScrierePDF " + nr + ".png";
        String circlingExerciseImagePath = "static/Incercuire cifra " + nr + ".png";
        String groupExerciseImagePath = "static/" + figura + " " + culoare + ".png";
        ClassLoader classLoader = getClass().getClassLoader();
        Image writingExerciseImage = Image.getInstance(classLoader.getResource(writingExerciseImagePath));
        writingExerciseImage.scaleAbsolute(450, 50);
        Image circlingExerciseImage = Image.getInstance(classLoader.getResource(circlingExerciseImagePath));
        circlingExerciseImage.scaleAbsolute(450, 100);
        Image groupExerciseImage = Image.getInstance(classLoader.getResource(groupExerciseImagePath));
